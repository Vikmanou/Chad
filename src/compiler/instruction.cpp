...
const std::unordered_map<Op, OpInfo> OPS = {
    {Op::Push, {"push", 0, false}},
    {Op::Rep, {"rep", 1, false}},
    {Op::Ghost, {"ghost", 1, false}},
    {Op::Pivot, {"pivot", 2, false}},
    {Op::Add, {"+", 2, true}},
    {Op::Sub, {"-", 2, true}},
    {Op::Mul, {"*", 2, true}},
    {Op::Div, {"/", 2, true}},
    {Op::Mod, {"%", 2, true}},
    {Op::Cope, {"cope", 1, false}},
    {Op::Mogs, {"mogs", 2, true}},
    {Op::LoopStart, {"[", 1, false}},
    {Op::LoopEnd, {"]", 1, false}},
    {Op::Sayc, {"sayc", 1, false}},
    {Op::Sayn, {"sayn", 1, false}},
    {Op::Readc, {"readc", 0, false}},
